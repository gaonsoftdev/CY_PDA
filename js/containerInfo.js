...
/*
	...
	created(){
		if(!GX._METHODS_.isLogin()) location.replace('login.html');
			...
			.body('<span>{{row.BottleNo}}</span><input type="text" v-if="index == 0" id="BottleNo" v-model="BottleNo" autofocus="autofocus" gx-scanner="Y"> ', 'code-help')
