...
var app = new Vue({
	...
	methods:{
		...
		InputPallet: function(){
			var vThis = this;
			if(vThis.queryForm.ReWorkPallet != '' && this.rows.Query.length > 0){
				let params = {QryType:'InputPalletQuery',Gubun:'IDD_PACK_PALL',InOutSerl:'3'};
				...
				.ajax([params],[
					function(data){
						if(data != null && data.length>0){
							vThis.rows.Query.splice(0, 0, data);
							vThis.initSelected();
						}
