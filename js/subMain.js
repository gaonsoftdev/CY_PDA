			...
			for(let i in data){
				if (data.hasOwnProperty(i)) {
					...
					if(obj != null) {
						...
						fileName = obj.link.split('.')[0];
						data[i].subTitle = GX.LANGS[GX.Cookie.get('lang')][fileName].menu;
						if (obj.subTitle == '세척완료') data[i].subTitle = GX.LANGS[GX.Cookie.get('lang')][fileName].menu2;
